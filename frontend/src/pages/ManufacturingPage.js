                        ...
                        <tr className={`${depth > 0 ? 'bg-[#F9FAFB]' : ''}`} data-testid={`wo-row-${wo.id}`}>
                          ...
                          <td>
                            ...
                            <div className="flex items-center flex-wrap gap-1">
                              ...
                              {/* Job Card is always available for in-progress inhouse MOs with ops — for BOTH parent and child MOs */}
                              ...
                              {/* Additional Direct-Complete shortcut for child MOs (SG/SA/Part) so user can skip Job Card tracking if they just want to mark done */}
