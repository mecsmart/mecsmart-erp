    ...
    <div className="space-y-6" data-testid="settings-page">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="item-groups" data-testid="item-groups-tab">Item Groups</TabsTrigger>
        </TabsList>
        ...
        {/* ====== Item Groups Tab ====== */}
        <TabsContent value="item-groups" className="space-y-4 mt-4" data-testid="item-groups-tab-content">
...
// when set, all items in the group inherit those values automatically.
// ------------------------------------------------------------------
function ItemGroupsCard({ isAdmin }) {
