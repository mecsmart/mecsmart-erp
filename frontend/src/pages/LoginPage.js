      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <span className="text-2xl font-bold font-[Chivo]">MachineWorks ERP</span>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center justify-center space-x-3 mb-8">
            ...
            <span className="text-xl font-bold font-[Chivo] text-[#1D3557]">MachineWorks ERP</span>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-[#4B5563]">
            Demo credentials: <span className="mono text-[#1D3557]">admin@erp.com / Admin@123</span>
          </p>
        </div>
      </div>
    </div>
