...
ALL_MODULES = [
    ...
    "suppliers", "customers",
    "purchase_orders", "purchase_invoices", "tax_invoices", "delivery_challan", "job_work",
...
DEFAULT_PERMISSIONS = {
    ...
    "quality_inspector": {
        ...
        "customers": [], "purchase_orders": [], "purchase_invoices": [], "tax_invoices": [],
